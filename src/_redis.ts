...
const NAME_PREFIX = "lorabridge:device:name";
...
export { getClient, NAME_PREFIX, ATTRIBUTES_PREFIX, DISABLED_PREFIX, REGISTRY_PREFIX, LOCK_PREFIX, HASH_ID, HASH_IEEE, REGISTRY_INDEX };
